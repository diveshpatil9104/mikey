...
| Concurrency (PC) | Blocking std threads + bounded channels | Small, predictable, no async runtime. One exception: the Linux Bluetooth module ([§ 14.2](14-tech-stack.md)). |
