...
| **Mikey for PC** (`mikeyd`) | Lightweight Rust tray app. Starts with the computer, lives in the system tray, always ready. Exposes a virtual mic and a virtual webcam to every app. |
