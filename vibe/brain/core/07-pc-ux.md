...
- **Off (default):** known devices connect instantly. New devices on USB or Bluetooth connect instantly. New devices on Wi‑Fi are asked **once** (see [§ 11.3](../architecture/11-sessions-trust.md)).
